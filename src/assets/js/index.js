...
class Splash {
    ...
    async startAnimation() {
        let splashes = [
            { "message": "4Kraft est un server sur Minecraft.", "author": "JustEnzo" },
            { "message": "Ce programme est en javascript.", "author": "JustEnzo" },
            { "message": "Si tu fait /battlepass tu pourra ouvrir le pass de combat.", "author": "JustEnzo" }
        ];
